    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogVisible">
      ...
      >
        <el-form-item label="会员id" prop="memberId">
          <el-input v-model.number="form.memberId" :disabled="show" />
        </el-form-item>
        <el-form-item label="场地id" prop="fieldId">
          <el-input v-model.number="form.fieldId" :disabled="show" />
        </el-form-item>
        ...
        <el-form-item label="日期" prop="startDate">
          <el-date-picker v-model="form.startDate" :disabled="show" type="date" placeholder="选择日期" />
        </el-form-item>
        <el-form-item label="开始时间" prop="startTime">
          <el-time-select v-model="form.startTime" :picker-options="{ start: '08:00', step: '00:30', end: '21:30', maxTime: form.endTime }" :disabled="show" format="HH:mm" placeholder="选择日期" />
        </el-form-item>
        <el-form-item label="结束时间" prop="endTime">
          <el-time-select v-model="form.endTime" :picker-options="{ start: '08:30', step: '00:30', end: '22:00', minTime: form.startTime }" :disabled="show" format="HH:mm" placeholder="选择日期" />
        </el-form-item>
      </el-form>
