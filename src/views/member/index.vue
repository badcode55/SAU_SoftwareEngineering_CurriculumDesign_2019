<template>
  <div>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogVisible">
      <el-form ref="form" :model="form" :rules="rules" :="left" label-width="70px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="等级" prop="grade">
          <el-select v-model="form.grade" placeholder="请选择教练等级">
            ...
            <el-option label="等级四" value="4" />
            <el-option label="等级五" value="5" />
          </el-select>
        </el-form-item>
